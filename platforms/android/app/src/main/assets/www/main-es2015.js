...
const routes = [
    ...
    {
        path: 'net-zero',
        loadChildren: () => Promise.all(/*! import() | net-zero-net-zero-module */[__webpack_require__.e("common"), __webpack_require__.e("net-zero-net-zero-module")]).then(__webpack_require__.bind(null, /*! ./net-zero/net-zero.module */ "./src/app/net-zero/net-zero.module.ts")).then(m => m.NetZeroPageModule)
    },
    {
        path: 'smart-home',
        loadChildren: () => __webpack_require__.e(/*! import() | smart-home-smart-home-module */ "smart-home-smart-home-module").then(__webpack_require__.bind(null, /*! ./smart-home/smart-home.module */ "./src/app/smart-home/smart-home.module.ts")).then(m => m.SmartHomePageModule)
    },
    {
        path: 'eco-device',
        loadChildren: () => Promise.all(/*! import() | eco-device-eco-device-module */[__webpack_require__.e("common"), __webpack_require__.e("eco-device-eco-device-module")]).then(__webpack_require__.bind(null, /*! ./eco-device/eco-device.module */ "./src/app/eco-device/eco-device.module.ts")).then(m => m.EcoDevicePageModule)
    },
    {
        path: 'carbon-fp',
        loadChildren: () => __webpack_require__.e(/*! import() | carbon-fp-carbon-fp-module */ "carbon-fp-carbon-fp-module").then(__webpack_require__.bind(null, /*! ./carbon-fp/carbon-fp.module */ "./src/app/carbon-fp/carbon-fp.module.ts")).then(m => m.CarbonFpPageModule)
    },
];
...
/* harmony import */ var _ionic_native_app_launcher_ngx__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ionic-native/app-launcher/ngx */ "./node_modules/@ionic-native/app-launcher/ngx/index.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _ionic_native_app_launcher_ngx__WEBPACK_IMPORTED_MODULE_10__["AppLauncher"],
...
module.exports = __webpack_require__(/*! /Users/ujwalc/Documents/dal/Term2/TI/ptoject/sav-my-bil/src/main.ts */"./src/main.ts");
